...
// make a more general 3d transform plan with interleaving dct/dst across the x, y, and z axes.
// planType is 0-7 corresponding to the 8 possibilities.
...
// perform a unitary transform corresponding to planType on each block of a passed in list.
// direction 1 is forward, -1 is inverse
...
// same as CompressAndWriteField, but using a sectioning of DCT/DST across the x/y/z axes
// given by 'planType'
...
// same as CompressAndWriteMatrixComponents, but with the more general DCT/DST given
// by 'planType'
